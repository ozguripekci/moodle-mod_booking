...
protected function transform_data_to_pricecategories_array(stdClass $pricecategoriesdata): array {
    ...
    if (
        ...
        foreach ($pricecategoriesdata->pricecategoryidentifier as $idx => $pricecategoryidentifier) {
            ...
            $pricecategory->startdate = $pricecategoriesdata->pricestart[$idx];
            $pricecategory->enddate = $pricecategoriesdata->priceend[$idx];

            if (!empty($pricecategory->identifier)) {
                $pricesarray[] = $pricecategory;
            } else {
...
protected function get_page_url_for_dynamic_submission(): moodle_url {
     ...
     * @return array
     */
private function pricecategories_get_changes($oldpricecategories, $data) {
