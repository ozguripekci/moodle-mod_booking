 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class price_categories implements renderable, templatable {
     ...
     */
    public function __construct(string $renderedpricecategoriesform, string $renderedchangepricecategoriesform) {

        $this->renderedpricecategoriesform = $renderedpricecategoriesform;
        $this->renderedchangepricecategoriesform = $renderedchangepricecategoriesform;
    ...
    public function export_for_template(renderer_base $output) {
        ...
        if ($this->renderedchangepricecategoriesform != '') {
            $returnarray['renderedchangepricecategoriesform'] = $this->renderedchangepricecategoriesform;
        }
